...
void test("parses DuckDuckGo results and unwraps target URLs", () => {
	const html = `
	...
	`;
	assert.equal(parseSearchResults(html, 1), "1. Example & Docs\nhttps://example.com/docs\nPrimary documentation.");
});

void test("single-line tool rows truncate instead of wrapping", () => {
	...
	assert.ok(!lines[0].includes("\u{1B}[0m"));
});

void test("identifies private and non-routable addresses", () => {
