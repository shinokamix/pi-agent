...
Preserve the intended meaning and tone. Do not rewrite quotations, code, commands, identifiers, or exact error messages merely to satisfy these style rules.

Before sending prose:

1. Scan it for the patterns below.
2. Rewrite any affected passages.
3. Make the voice sound natural rather than sterile.
4. Ask, "What makes this sound AI-generated?" Fix anything that remains.
